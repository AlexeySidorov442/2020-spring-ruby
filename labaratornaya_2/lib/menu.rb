...
class Menu
    ...
    MAIN_MENU_CHOICES = [
      ...
      def show_statistic
        ...
        print "7A - #{a}, Баллов в классе : #{avgA}\n"
        print "7Б - #{b}, Баллов в классе : #{avgB}\n"
        print "7В - #{v}, Баллов в классе : #{avgV}\n"
        print "7Г - #{g}, Баллов в классе : #{avgG}\n"
        print "7Д - #{d}, Баллов в классе : #{avgD}\n"
      end
end